import {PencilIcon, PhoneIcon, ServerIcon, UserPlusIcon} from '@heroicons/react/20/solid'
import {BookOpenIcon, ChartBarIcon, FingerPrintIcon, UsersIcon} from '@heroicons/react/24/outline'
import {useNavigate} from "react-router-dom";

export default function Home() {
    const navigate = useNavigate();
    const stats = [
        {id: 1, name: 'Tests Administered', value: '10 million'},
        {id: 2, name: 'Organizations Served', value: '5,000+'},
        {id: 3, name: 'Average Uptime', value: '99.9%'},
    ]

    const features = [
        {
            name: 'Create Custom Tests',
            description:
                'Design tests that fit your specific needs with our intuitive test creation tools. Add multiple choice, true/false, short answer, and many other question types with ease.',
            icon: BookOpenIcon,
        },
        {
            name: 'Manage Participants',
            description:
                'Easily manage test-takers with our robust participant management system. Add users, assign roles, and monitor progress in real time.',
            icon: UsersIcon,
        },
        {
            name: 'Analyze Results',
            description:
                'Gain valuable insights with our powerful analytics tools. Generate detailed reports, track performance trends, and make data-driven decisions.',
            icon: ChartBarIcon,
        },
        {
            name: 'Secure and Reliable',
            description:
                'Your data is safe with us. TestSystem ensures the highest level of security for your test content and user information.',
    ...
    return (
        <>
            ...
            <section className="relative isolate px-6 pt-14 lg:px-8">
                <div className="mx-auto max-w-2xl py-32 sm:py-30 lg:py-36">
                    <div className="hidden sm:mb-8 sm:flex sm:justify-center">
                        <div
                            className="relative rounded-full px-3 py-1 text-sm leading-6 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                            Currently in poverty click more for to donate.
                            <a onClick={navigate("/login")} className="font-semibold text-indigo-600">
                    ...
                    <div className="text-center">
                        <h1 className="text-4xl font-bold tracking-tight sm:text-6xl">
                            Welcome to <span
                            className="text-violet-600">TestSystem</span> Platform
                        </h1>
                        <p className="mt-6 text-lg leading-8">
                            Your ultimate solution for creating, managing, and administering tests seamlessly.
                        </p>
                        <div className="mt-10 flex items-center justify-center gap-x-6">
                            ...
                            <a href="#" className="text-sm font-semibold leading-6" onClick={navigate("/login")}>
            ...
            <section className="relative isolate overflow-hidden px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
                ...
                <div
                    ...
                    <div
                        ...
                        <div className="lg:pr-4">
                            <div className="lg:max-w-lg">
                                <p className="text-base font-semibold leading-7 text-indigo-600">Efficiency and
                                    Excellence</p>
                                <h1 className="mt-2 text-3xl font-bold tracking-tight sm:text-4xl">Why Choose
                                    TestSystem?</h1>
                                <p className="mt-6 text-xl leading-8">
                                    Optimize your testing process with TestSystem. Our
                                    platform offers seamless integration, robust security, and comprehensive analytics
                                    to ensure a superior testing experience for administrators and users alike.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div
                        ...
                        <img
                            alt=""
                            src="https://www-cms.pipedriveassets.com/cdn-cgi/image/quality=70,format=auto/https://www-cms.pipedriveassets.com/Pipedrive-Dark-Theme.png"
                    ...
                    <div
                        ...
                        <div className="lg:pr-4">
                            <div className="max-w-xl text-base leading-7 lg:max-w-lg">
                                <p>
                                    Discover the unparalleled features that make TestSystem the ideal choice for all
                                    your
                                    testing needs:
                                </p>
                                <ul role="list" className="mt-8 space-y-8">
                                    <li className="flex gap-x-3">
                                        ...
                                        <span>
                    <strong className="font-semibold">User-Friendly Interface.</strong> Our platform is designed with simplicity in mind. Easily navigate through features and functionalities with our user-friendly interface.
                  </span>
                                    </li>
                                    <li className="flex gap-x-3">
                                        <PencilIcon aria-hidden="true"
                                                    className="mt-1 h-5 w-5 flex-none text-indigo-600"/>
                                        <span>
                    <strong className="font-semibold">Customizable Branding.</strong> Personalize your testing experience by adding your organization’s logo and colors. Create a cohesive brand experience for your test-takers.
                  </span>
                                    </li>
                                    <li className="flex gap-x-3">
                                        <ServerIcon aria-hidden="true"
                                                    className="mt-1 h-5 w-5 flex-none text-indigo-600"/>
                                        <span>
                    <strong className="font-semibold">Flexible Integration.</strong> Integrate TestSystem with your existing systems and workflows. Our platform supports various integrations to ensure a seamless experience.
                  </span>
                                    </li>
                                    <li className="flex gap-x-3">
                                        <PhoneIcon aria-hidden="true"
                                                   className="mt-1 h-5 w-5 flex-none text-indigo-600"/>
                                        <span>
                    <strong className="font-semibold">24/7 Support.</strong> Our dedicated support team is here to help you every step of the way. Get assistance whenever you need it with our 24/7 customer support.
                  </span>
                                    </li>
                                </ul>
                                <p className="mt-8">
                                    Experience the power of a platform designed for speed, security, and
                                    reliability. TestSystem is the perfect solution for educators, corporate trainers,
                                    and organizations of all sizes.
                                </p>
                                <h2 className="mt-16 text-2xl font-bold tracking-tight">Cloud-Based Convenience</h2>
                                <p className="mt-6">
                                    Enjoy the flexibility of a cloud-based solution, eliminating the
                                    need for server management. Access your tests anytime, anywhere, and from any
                                    device.
                                </p>
                            </div>
                        </div>
            ...
            <section className="py-24 sm:py-32">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <h2 className="text-center text-lg font-semibold leading-8">Trusted by the world’s
            ...
            <section className="py-24 sm:py-32">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl lg:text-center">
                        ...
                        <p className="mt-6 text-lg leading-8">
                            Our platform is packed with features that streamline the
                            testing process, ensuring an efficient, secure, and insightful experience for both
            ...
            <section className="bg-indigo-700 rounded-lg py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="lg:flex lg:items-center lg:justify-between">
                        ...
                        <div className="mt-8 lg:mt-0 lg:ml-8 sm:flex sm:justify-center">
                            <form className="sm:flex">
                                <input
                                    type="email"
                                    placeholder="Enter your email"
                                    className="w-full px-5 py-3 border border-transparent rounded-md bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-xs"
                                />
                                <button
                                    type="submit"
                                    className="mt-3 w-full px-5 py-3 border border-transparent text-base font-medium rounded-md text-indigo-700 bg-white hover:bg-indigo-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:flex-shrink-0"
                                >
                                    Subscribe
                                </button>
                            </form>
                    ...
                    <p className="mt-3 text-sm text-indigo-200 text-center lg:text-left">
                        We care about your data. <a href="https://www.williamto.com/" className="underline text-white">Read
