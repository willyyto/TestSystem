    ...
    return (
        <div className="flex gap-4 h-full items-center cursor-pointer">
            <Accordion className="px-0">
                <AccordionItem
                    indicator={<ChevronUpIcon className="w-5 h-5" />}
                    classNames={{
                        indicator: "data-[open=true]:-rotate-180",
                        trigger:
                            "py-0 min-h-[44px] hover:bg-default-100 rounded-xl data-[open=true]:bg-primary-100 active:scale-[0.98] transition-transform px-3.5",

                        title:
                            "px-0 flex text-base font-semibold gap-2 h-full items-center cursor-pointer",
                    }}
